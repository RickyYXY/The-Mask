...
from .styleganinv_generator_network import StyleGANGeneratorNet

__all__ = ['StyleGANInvGenerator']


class StyleGANInvGenerator(BaseGenerator):
    ...
    def __init__(self, model_name='styleganinv_ffhq256', logger=None):
    ...
    def _synthesize(self,
        ...
        ls = None if labels is None else self.to_tensor(
