...
class StyleGANInverter(object):
    ...
    def __init__(self,
        ...
        self.F = PerceptualModel(
            min_val=self.G.min_val, max_val=self.G.max_val)
    ...
    def preprocess(self, image):
        ...
        image = image / 255.0 * \
            (self.G.max_val - self.G.min_val) + self.G.min_val
    ...
    def invert(self, image, num_viz=0):
        ...
        viz_results.append(self.G.postprocess(
            _get_tensor_value(x_init_inv))[0])
